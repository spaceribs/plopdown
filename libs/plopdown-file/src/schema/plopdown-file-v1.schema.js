      ...
      if ((data && typeof data === "object" && !Array.isArray(data))) {
        if (true) {
          ...
          for (var key0 in data) {
            var isAdditional0 = !(false || key0 == 'data' || key0 == 'endTime' || key0 == 'id' || key0 == 'startTime');
            if (isAdditional0) {
              valid1 = false;
              validate.errors = [{
                              ...
                              if (valid2) {
                                if (data1.origin === undefined) {
                                  ...
                                  if (typeof data1.origin !== "string") {
                                    validate.errors = [{
                                      keyword: 'type',
                                      dataPath: (dataPath || '') + '.headers.origin',
                                      schemaPath: '#/properties/headers/properties/origin/type',
                                      params: {
                                        type: 'string'
                                      },
                                      message: 'should be string'
                                ...
                                if (valid2) {
                                  ...
                                  if (data2 === undefined) {
                                    ...
                                    if (typeof data2 !== "string" && data2 !== null) {
                                      validate.errors = [{
                                        keyword: 'type',
                                        dataPath: (dataPath || '') + '.headers.path',
                                        schemaPath: '#/properties/headers/properties/path/type',
                                        params: {
                                          type: 'string,null'
                                        },
                                  ...
                                  if (valid2) {
                                    ...
                                    if (data2 === undefined) {
                                      ...
                                      if (typeof data2 !== "string" && data2 !== null) {
                                        validate.errors = [{
                                          keyword: 'type',
                                          dataPath: (dataPath || '') + '.headers.search',
                                          schemaPath: '#/properties/headers/properties/search/type',
                                          params: {
                                            type: 'string,null'
                                          },
                                          message: 'should be string,null'
